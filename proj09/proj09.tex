...
\begin{table}[!ht]
    ...
    \begin{tabular}{ccccc}
        ...
        \fbox{\includegraphics[width=32px,height=32px]{region16-03.png}} & \fbox{\includegraphics[width=32px,height=32px]{fft03.png}} & 0 & 0    & 1.57\\
        \fbox{\includegraphics[width=32px,height=32px]{region16-40.png}} & \fbox{\includegraphics[width=32px,height=32px]{fft40.png}} & 1 & 1    & 1.57\\
        \fbox{\includegraphics[width=32px,height=32px]{region16-20.png}} & \fbox{\includegraphics[width=32px,height=32px]{fft20.png}} & 2 & 1.41 & 0.78\\
        \fbox{\includegraphics[width=32px,height=32px]{region16-23.png}} & \fbox{\includegraphics[width=32px,height=32px]{fft23.png}} & 2 & 2    & 0\\
        \fbox{\includegraphics[width=32px,height=32px]{region16-26.png}} & \fbox{\includegraphics[width=32px,height=32px]{fft26.png}} & 2 & 2.24 & -0.78\\
        \fbox{\includegraphics[width=32px,height=32px]{region16-30.png}} & \fbox{\includegraphics[width=32px,height=32px]{fft30.png}} & 3 & 2.83 & -0.78\\
        \bottomrule
     \end{tabular}
\end{table}
