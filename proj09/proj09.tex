...
\begin{table}[!ht]
    ...
    \begin{tabular}{ccccc}
        ...
        \fbox{\includegraphics[width=32px,height=32px]{region16-03.png}} & \fbox{\includegraphics[width=32px,height=32px]{fft03.png}} & 0 & 0    & ?\\
        \fbox{\includegraphics[width=32px,height=32px]{region16-40.png}} & \fbox{\includegraphics[width=32px,height=32px]{fft40.png}} & 1 & 1    & ?\\
